...
OUT_DIR = REPO / "benchmark_results_w5msweep"
LOG_DIR = OUT_DIR / "logs"

# m=500 at w=5 already has 100 seeds in benchmark_results_wsweep. Here we add
# the high-density points to probe whether the tight-horizon regime (w=5)
# preserves section's throughput edge at scale.
M_CONFIG = [
    (700, 30),
    (800, 30),
]
